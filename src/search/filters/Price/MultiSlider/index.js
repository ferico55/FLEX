...
import { StyleSheet, PanResponder, View, Platform } from 'react-native'
...
export default class MultiSlider extends React.Component {
    ...
    if (Math.abs(gestureState.dy) < slipDisplacement || !slipDisplacement) {
      ...
      if (value !== this.state.valueOne) {
        this.setState(
          ...
          () => {
            this.props.onValuesChange({min:this.state.valueOne,equal:this.state.valueOne===this.state.valueTwo})
          },
        )
      }
    }
    ...
    if (Math.abs(gestureState.dy) < slipDisplacement || !slipDisplacement) {
      ...
      if (value !== this.state.valueTwo) {
        this.setState(
          ...
          () => {
            this.props.onValuesChange({max:this.state.valueTwo,equal:this.state.valueOne===this.state.valueTwo})
          },
        )
      }
    }
  ...
  render() {
    ...
    const markerContainerOne = {
      top: markerOffsetY - 23,
      left: trackOneLength + markerOffsetX - 24 - 15,
    }

    const markerContainerTwo = {
      top: markerOffsetY - 23,
      right: trackThreeLength + markerOffsetX - 24 - 15,
    }
