...
import { G, Rect, Polygon, Circle, Text } from "react-native-svg";
import {
  StyleSheet,
  View,
  TouchableOpacity,
...
import { Voronoi } from "victory-native";

class StatisticChartToolTip extends Component {
  render() {
    const { x, y, datum, orientation } = this.props;
