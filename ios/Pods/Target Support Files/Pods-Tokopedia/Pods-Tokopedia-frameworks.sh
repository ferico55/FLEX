...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EZYGradientView-ObjC/EZYGradientView_ObjC.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JLPermissions/JLPermissions.framework"
