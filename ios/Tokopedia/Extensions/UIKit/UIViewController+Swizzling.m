...
+ (void)load {
    ...
    static dispatch_once_t willAppearToken;
    dispatch_once(&willAppearToken, ^{
        Class class = [self class];
        
        SEL originalSelector = @selector(viewWillAppear:);
        SEL swizzledSelector = @selector(tkpd_viewWillAppear:);
...
- (void)tkpd_viewWillAppear:(BOOL)animated {
    [self tkpd_viewWillAppear:animated];
