...
+ (NSString*)graphQLURL {
    ...
    NSDictionary* urls = @{
                           ...
                           @(TPUrlStaging) : @"https://gql-staging.tokopedia.com/graphql",
                           @(TPUrlAlpha) : @"http://192.168.100.151:9096",
                           @(TPUrlDevelopment) : @"http://192.168.100.151:9096"
                           };
...
+ (NSString*)apiURL {
    ...
    NSDictionary* urls = @{
                           @(TPUrlProduction) : @"https://api.tokopedia.com",
                           @(TPUrlStaging) : @"https://api-staging.tokopedia.com",
                           @(TPUrlAlpha) : @"https://api-staging.tokopedia.com",
                           @(TPUrlDevelopment) : @"https://api-staging.tokopedia.com"
                           };
