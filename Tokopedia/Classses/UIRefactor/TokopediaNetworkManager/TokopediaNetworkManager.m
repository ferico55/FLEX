...
- (void)doRequest {
    ...
    if(self.isUsingHmac) {
        ...
        NSString *signature = [hmac generateSignatureWithMethod:[self getStringRequestMethod:requestMethod] tkpdPath:[_delegate getPath:self.tagRequest] parameter:[_delegate getParameter:self.tagRequest] date:date];
