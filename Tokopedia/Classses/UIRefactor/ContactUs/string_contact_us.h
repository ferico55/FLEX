...
#ifndef Tokopedia_string_contact_us_h
#define Tokopedia_string_contact_us_h

#define API_TICKET_CATEGORY_CHILD_KEY       @"ticket_category_child"
#define API_TICKET_CATEGORY_NAME_KEY        @"ticket_category_name"
#define API_TICKET_CATEGORY_TREE_NO_KEY     @"ticket_category_tree_no"
