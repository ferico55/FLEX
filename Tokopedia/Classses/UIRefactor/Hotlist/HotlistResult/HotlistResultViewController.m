...
-(void)pushDynamicSort{
    FiltersController *controller = [[FiltersController alloc]initWithSource:@"hotlist" sortResponse:_filterResponse?:[FilterData new] selectedSort:_selectedSort presentedVC:self onCompletion:^(ListOption * sort, NSDictionary*paramSort) {
...
-(void)pushDynamicFilter{
    FiltersController *controller = [[FiltersController alloc]initWithSource:@"hotlist" filterResponse:_filterResponse?:[FilterData new] categories:[_initialCategories copy] selectedCategories:_selectedCategories selectedFilters:_selectedFilters presentedVC:self onCompletion:^(NSArray<CategoryDetail *> * selectedCategories , NSArray<ListOption *> * selectedFilters, NSDictionary* paramFilters) {
