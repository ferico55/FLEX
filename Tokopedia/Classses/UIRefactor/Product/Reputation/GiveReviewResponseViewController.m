...
//    UIEdgeInsets contentInsets = UIEdgeInsetsMake(0, 0, keyboardSize.height, 0);
    ...
    CGRect frame = CGRectMake(0, _pageView.frame.size.height - keyboardSize.height - _giveResponseView.frame.size.height, _giveResponseView.frame.size.width, _giveResponseView.frame.size.height);
...
- (void)keyboardWillHide:(NSNotification*)notification {
    CGRect frame = CGRectMake(0, _pageView.frame.size.height - - _giveResponseView.frame.size.height, _giveResponseView.frame.size.width, _giveResponseView.frame.size.height);
