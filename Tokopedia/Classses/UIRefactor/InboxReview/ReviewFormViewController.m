...
- (void)doSendReview {
    ...
    _requestCount++;
    _request = [_objectManager appropriateObjectRequestOperationWithObject:self method:RKRequestMethodPOST path:ADD_REVIEW_PATH parameters:[NSDictionary encryptDictionary:[self getEditedParam]]];
