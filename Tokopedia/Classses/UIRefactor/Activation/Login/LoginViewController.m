...
- (void)checkSecurityQuestion {
    ...
    controller.questionType1 = @"1";//_login.result.security.user_check_security_1;
    controller.questionType2 = @"0";//_login.result.security.user_check_security_2;
