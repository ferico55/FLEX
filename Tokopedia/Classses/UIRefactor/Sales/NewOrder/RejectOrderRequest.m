...
-(void)requestActionRejectOrderWithOrderId:(NSString *)orderId emptyProducts:(NSArray *)products reasonCode:(NSString *)reasonCode closeEnd:(NSString *)closeEnd closeNote:(NSString *)closeNote onSuccess:(void (^)(GeneralAction *))successCallback onFailure:(void (^)(NSError *))errorCallback{
    proceedOrderNetworkManager = [TokopediaNetworkManager new];
    proceedOrderNetworkManager.isUsingHmac = YES;
    proceedOrderNetworkManager.isUsingDefaultError = NO;
