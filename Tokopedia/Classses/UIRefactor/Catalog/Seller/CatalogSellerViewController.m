...
@interface CatalogSellerViewController ()<UITableViewDelegate, UITableViewDataSource,CatalogSellerCellDelegate,SortViewControllerDelegate,FilterViewControllerDelegate>
{
