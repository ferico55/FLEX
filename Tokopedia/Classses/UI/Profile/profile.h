...
typedef enum
{
    kTKPDPROFILESETTINGLOCATION_DATATYPEDEFAULTVIEWKEY = 0,
    kTKPDPROFILESETTINGLOCATION_DATATYPEPROVINCEKEY,
    kTKPDPROFILESETTINGLOCATION_DATATYPEDISTICTKEY,
    kTKPDPROFILESETTINGLOCATION_DATATYPEREGIONKEY
} kTKPDLOCATIONTYPE;
...
#define kTKPDPROFILE_DATALOCATIONVALUEKEY @"locationvalue"
#define kTKPDPROFILE_DATALOCATIONNAMEKEY @"locationname"
#define kTKPDPROFILE_DATALOCATIONPROVINCEINDEXPATHKEY @"provinceindexpath"
#define kTKPDPROFILE_DATABANKINDEXPATHKEY @"bankindexpath"
#define kTKPDPROFILE_DATALOCATIONCITYINDEXPATHKEY @"cityindexpath"
#define kTKPDPROFILE_DATALOCATIONDISTRICTINDEXPATHKEY @"districtindexpath"
