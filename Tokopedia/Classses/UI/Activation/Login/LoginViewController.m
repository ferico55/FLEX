...
- (void)configureRestKitLogin
{
    ...
    [resultMapping addAttributeMappingsFromDictionary:@{kTKPDLOGIN_APIISLOGINKEY:kTKPDLOGIN_APIISLOGINKEY,
                                                       ...
                                                       kTKPLOGIN_APIFULLNAMEKEY:kTKPLOGIN_APIFULLNAMEKEY
                                                        }];
...
-(void)requestsuccessLogin:(id)object
{
    ...
    if (status) {
        ...
        if (!_login.message_error) {
            ...
            [nc postNotificationName:TKPD_ISLOGINNOTIFICATIONNAME object:nil userInfo:@{}];
        ...
        else
        {
            ...
            for (int i = 0; i<messages.count; i++) {
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"ERROR" message:messages[i] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
                [alertView show];
            }
        }
    }
