...
#define kTKPDCATEGORY_TITLEARRAY @[@"Pakaian",@"Handphone & Tablet", @"Office & Stationary", @"Fashion & Aksesoris", @"Laptop & Aksesoris", @"souvenir, Kado & Hadiah", @"Kecantikan", @"Komputer & Aksesoris", @"Mainan & Hobi", @"Kesehatan", @"Electronik", @"Makanan & Minuman", @"Rumah Tangga", @"Kamera, Foto & Video", @"Buku", @"Dapur", @"Otomotif", @"Software", @"Perawatan Bayi", @"Olahraga", @"Film, Musik & Game", @"Produk Lainnya"]
#define kTKPDCATEGORY_IDARRAY @[@"78",@"65",@"59",@"53",@"288",@"54",@"61",@"297",@"55",@"715",@"60",@"35",@"984",@"578",@"8",@"983",@"63",@"20",@"56",@"62",@"57",@"36"]
