...
@interface HotlistAuthViewController ()
{
...
@implementation HotlistAuthViewController
...
- (void)configureRestKit
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:statusMapping method:RKRequestMethodPOST pathPattern:kTKPDHOMEHOTLIST_APIPATH keyPath:@"" statusCodes:kTkpdIndexSetStatusCodeOK];
...
- (void)loadData
{
    ...
    NSString *encryptedParam = [_userManager addParameterAndConvertToString:param];
    NSString *encodedKey   = _encodeDecodeManager.encryptKeyAndIv;
    NSString *encodedParam = [_encodeDecodeManager encryptParams:encryptedParam];
    NSDictionary *keyAndParam = @{@"key" : encodedKey, @"param" : encodedParam};

    _request = [_objectmanager appropriateObjectRequestOperationWithObject:self method:RKRequestMethodPOST path:kTKPDHOMEHOTLIST_APIPATH parameters:keyAndParam];
