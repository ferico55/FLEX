...
#define kTKPDCAMERA_DATAPRESENTINGVIEWCONTROLLERCLASSKEY @"presentingviewcontrollerclass"
...
#define kTKPDCAMERA_UPLOADEDIMAGERECT CGRectMake(0, 0, 1024, 1024)
#define kTKPDCAMERA_UPLOADEDIMAGESIZE CGSizeMake(1024, 1024)
