...
@implementation ShopProductViewCell

#pragma mark - Factory Methods
+ (id)newcell
{
    NSArray* a = [[NSBundle mainBundle] loadNibNamed:@"ShopProductViewCell" owner:nil options:0];
    for (id o in a) {
...
- (IBAction)gesture:(id)sender {
    ...
    if ([sender isKindOfClass:[UITapGestureRecognizer class]]) {
        ...
        [_delegate ShopProductViewCell:self withindexpath:indexpath1];
