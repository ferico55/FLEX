...
+ (CAGradientLayer*) blueGradient {
    ...
    NSArray *colors = [NSArray arrayWithObjects:(id)colorOne.CGColor, colorTwo.CGColor, colorTransparent.CGColor, nil];
    NSNumber *stopOne = [NSNumber numberWithFloat:0.0];
...
+ (CAGradientLayer*) blackGradient {
    ...
    NSArray *colors = [NSArray arrayWithObjects:(id)colorTransparent.CGColor, colorTwo.CGColor, colorTransparent.CGColor, nil];
    NSNumber *stopOne = [NSNumber numberWithFloat:0.0];
    NSNumber *stopTwo = [NSNumber numberWithFloat:1.0];
