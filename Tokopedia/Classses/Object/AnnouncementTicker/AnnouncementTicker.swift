...
class AnnouncementTicker: NSObject {
    var meta: AnnouncementTickerMeta!
    var data: AnnouncementTickerResult!
    
    static func mapping() -> RKObjectMapping! {
        let mapping = RKObjectMapping(forClass: self)
        
        mapping.addPropertyMapping(RKRelationshipMapping(fromKeyPath: "meta", toKeyPath: "meta", withMapping: AnnouncementTickerMeta.mapping()))
