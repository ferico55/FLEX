...
+(RKObjectMapping*)mapping
{
    ...
    [mapping addPropertyMapping:[RKRelationshipMapping relationshipMappingFromKeyPath:@"data" toKeyPath:@"data" withMapping:[TransactionATCFormResult mapping]]];
    return mapping;
}
