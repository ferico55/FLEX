...
@property (nonatomic, strong) NSNumber *last_show_input_resi_button;
@property (nonatomic, strong) NSNumber *last_rival_accepted;
@property (nonatomic, strong) NSString *last_refund_amt_idr;
@property (nonatomic, strong) NSNumber *last_refund_amt;
@property (nonatomic, strong) NSString *last_user_name;
