...
+(RKObjectMapping*)mapping
{
    ...
    RKRelationshipMapping *relMapping = [RKRelationshipMapping relationshipMappingFromKeyPath:@"ticket_attachment" toKeyPath:@"ticket_attachment" withMapping:[InboxTicketDetailAttachment mapping]];
