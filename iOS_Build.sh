...
xcodebuild -workspace Tokopedia.xcworkspace -configuration Release -scheme Tokopedia CONFIGURATION_BUILD_DIR=JenkinsBuild
...
xcodebuild -workspace Tokopedia.xcworkspace -configuration Release -scheme Tokopedia archive CODE_SIGN_IDENTITY="iPhone Developer: Melissa Juminto (TT6A3N9KTC)" -archivePath ./JenkinsArchive/Tokopedia.xcarchive -destination generic/platform=iOS
